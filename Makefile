...
verify-cudaq-python:
	...
	env -u DWAVE_API_TOKEN QUBONOTEBOOKS_DWAVE_ENABLE_QPU=0 CUDA_VISIBLE_DEVICES="" PYTHONWARNINGS=error OMP_NUM_THREADS=2 OPENBLAS_NUM_THREADS=2 UV_CACHE_DIR=$(UV_CACHE_DIR) $(UV) run --locked $(CUDAQ_UV_GROUP_FLAGS) python ./scripts/verify_cudaq.py $(CUDAQ_PYTHON_NOTEBOOKS)
