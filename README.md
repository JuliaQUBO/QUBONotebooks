...
| Optional CUDA-Q CPU | CPU simulation plus D-Wave Python local path | `make verify-cudaq-python` | CI budget: 10 minutes; cold sync measured 10–41 seconds | None required; Python 3.11–3.12; see [platform and size details](local-setup.md#optional-cuda-q) |
