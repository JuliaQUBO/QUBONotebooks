...
| Optional CUDA-Q CPU | QAOA in the QUBO notebook and quantum annealing in the D-Wave notebook | `make verify-cudaq-python` | CI budget: 10 minutes including installation | None required; Python 3.11–3.12; see [platform and size details](local-setup.md#optional-cuda-q) |
