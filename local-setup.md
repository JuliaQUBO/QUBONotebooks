...
CUDA-Q-enabled CPU run. Missing-package tests and portable notebook targets
verify the skip paths. The CUDA-Q target requires both optimization sections
to complete their numerical checks; a missing dependency cannot silently skip.
